  ...
  <div class="Worker">
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '感染症の拡大を理由として、国の雇用調整助成金等を活用し、非常時における勤務体制づくりなど職場環境整備に取り組む市内中小企業に奨励金を支給します（1事業所10万円）。'
          )
        }}
      </p>
    </StaticCard>
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '市内中堅・中小企業に対し、テレワークの導入に必要な機器やソフトウェア等の経費を助成します（限度額250万円、助成率10/10）。ぜひご活用ください。'
          )
        }}
      </p>
    </StaticCard>
